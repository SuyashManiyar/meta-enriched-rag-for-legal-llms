...
def create_line_plots(metrics_data):
    ...
    import os
    os.makedirs('RAG_pipeline/plots', exist_ok=True)
    
    # Save with descriptive experiment-based naming
    plt.savefig('RAG_pipeline/plots/australian_legal_chunking_comparison_span_recall_drm.png', dpi=300, bbox_inches='tight')
    plt.savefig('RAG_pipeline/plots/australian_legal_chunking_comparison_span_recall_drm.pdf', bbox_inches='tight')
    
    print("Line plots (Australian Legal - Chunking Comparison) saved as:")
    print("- RAG_pipeline/plots/australian_legal_chunking_comparison_span_recall_drm.png")
    print("- RAG_pipeline/plots/australian_legal_chunking_comparison_span_recall_drm.pdf")
